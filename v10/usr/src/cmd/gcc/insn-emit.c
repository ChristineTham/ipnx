...
rtx
gen_movstrhi (operand0, operand1, operand2)
     rtx operand0;
     rtx operand1;
     rtx operand2;
{
  return gen_rtx (PARALLEL, VOIDmode, gen_rtvec (8,
		...
		gen_rtx (CLOBBER, VOIDmode, gen_rtx (REG, SImode, 3)),
		gen_rtx (CLOBBER, VOIDmode, gen_rtx (REG, SImode, 4)),
		gen_rtx (CLOBBER, VOIDmode, gen_rtx (REG, SImode, 5))));
}
...
rtx
gen_andcbsi3 (operand0, operand1, operand2)
     rtx operand0;
     rtx operand1;
     rtx operand2;
{
  return gen_rtx (SET, VOIDmode, operand0, gen_rtx (AND, SImode, operand1, gen_rtx (NOT, SImode, operand2)));
}

rtx
gen_andcbhi3 (operand0, operand1, operand2)
     rtx operand0;
     rtx operand1;
     rtx operand2;
{
  return gen_rtx (SET, VOIDmode, operand0, gen_rtx (AND, HImode, operand1, gen_rtx (NOT, HImode, operand2)));
}

rtx
gen_andcbqi3 (operand0, operand1, operand2)
     rtx operand0;
     rtx operand1;
     rtx operand2;
{
  return gen_rtx (SET, VOIDmode, operand0, gen_rtx (AND, QImode, operand1, gen_rtx (NOT, QImode, operand2)));
}
...
gen_rotldi3 (operand0, operand1, operand2)
     ...
     rtx operand2;
{
  return gen_rtx (SET, VOIDmode, operand0, gen_rtx (ROTATE, DImode, operand1, operand2));
}
...
gen_casesi (operand0, operand1, operand2, operand3)
     ...
     rtx operand3;
{
  return gen_rtx (SET, VOIDmode, pc_rtx, gen_rtx (IF_THEN_ELSE, VOIDmode, gen_rtx (LE, VOIDmode, gen_rtx (MINUS, SImode, operand0, operand1), operand2), gen_rtx (PLUS, SImode, gen_rtx (SIGN_EXTEND, SImode, gen_rtx (MEM, HImode, gen_rtx (PLUS, SImode, pc_rtx, gen_rtx (MINUS, SImode, operand0, operand1)))), gen_rtx (LABEL_REF, SImode, operand3)), pc_rtx));
}
