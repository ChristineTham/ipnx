static	char sccsid[] = "@(#)pc.c 3.12 6/8/81";
#include <stdio.h>
#include <signal.h>
#include <wait.h>
 ...
 */
char	*pc0 = "/usr/lib/pascal/pc0";
char	*pc1 = "/lib/f1";
char	*pc2 = "/usr/lib/pascal/pc2";
char	*c2 = "/lib/c2";
char	*pc3 = "/usr/lib/pascal/pc3";
char	*ld = "/bin/ld";
char	*as = "/bin/as";
char	*lpc = "-lpc";
	...
	char **argv;
{
	...
	for (i = 0; i < argc; i++) {
		...
		case 'T':
			...
			case '0':
				pc0 = "/usr/src/cmd/pc0/pascal/a.out";
				if (argp[3] != '\0') {
					pc0 = &argp[3];
				}
				continue;
...
duplicate:
	...
	if (gflag)
		ldargs[ldargx++] = "-lg";
/* V8 has math library combined into C library. -mjs
	ldargs[ldargx++] = "-lnm";
*/
	ldargs[ldargx++] = "-lc";
	ldargs[ldargx] = 0;
