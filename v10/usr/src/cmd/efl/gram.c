...
short yydef[]={
 ...
 116, 117,   0, 119, 120,   0, 130, 131,   2,   8,
  ...
  38, 158,  38,   0, 196,  38,  38,  38,  -2, 211,
...
case 10:
/* # line 164 "gram.in" */
{ if(dclsect && ((struct headbits *)yypvt[-1].pval)->tag!=TSTFUNCT)
			dclsect = 0;
...
case 14:
/* # line 178 "gram.in" */
{ ((struct execblock *)thisexec)->copylab = 1; } break;
case 15:
/* # line 179 "gram.in" */
{ yyval.pval = addexec(); ((struct execblock *)thisexec)->copylab = 0; } break;
case 16:
/* # line 183 "gram.in" */
...
case 25:
/* # line 228 "gram.in" */
{ yyval.pval = (int *)mkchain(yypvt[-0].pval,CHNULL); } break;
case 26:
/* # line 230 "gram.in" */
{ hookup(yypvt[-2].pval, mkchain(yypvt[-0].pval,CHNULL) ); } break;
case 27:
/* # line 234 "gram.in" */
{ if(((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->vclass == CLUNDEFINED)
			((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->vclass = CLARG;
		  else dclerr("argument already used", ((struct stentry *)((struct defblock /*|| struct labelblock|| struct varblock|| struct keyblock|| struct typeblock */ *)yypvt[-0].pval)->sthead)->namep);
		} break;
case 28:
/* # line 240 "gram.in" */
{ optneed = 0; } break;
...
case 35:
/* # line 264 "gram.in" */
{ setopt(yypvt[-2].pval,((struct iostblock /*|| struct exprblock */ *)yypvt[-0].pval)->leftp); cfree(yypvt[-2].pval); cfree(yypvt[-0].pval); } break;
case 36:
/* # line 268 "gram.in" */
{ defneed = 1; } break;
case 37:
...
case 41:
/* # line 285 "gram.in" */
{ yyval.pval = (int *)hookup(yypvt[-2].pval,yypvt[-0].pval); } break;
case 44:
/* # line 293 "gram.in" */
...
case 61:
/* # line 330 "gram.in" */
{ imptype = ((struct atblock *)yypvt[-0].pval)->attype; cfree(yypvt[-0].pval); } break;
case 64:
/* # line 338 "gram.in" */
...
case 69:
/* # line 352 "gram.in" */
{ yyval.pval = (int *)mkchain(yypvt[-2].pval, mkchain(yypvt[-0].pval,CHNULL)); } break;
case 70:
/* # line 354 "gram.in" */
{ yyval.pval = (int *)hookup(yypvt[-2].pval, mkchain(yypvt[-0].pval,CHNULL)); } break;
case 72:
/* # line 358 "gram.in" */
{ attatt(yypvt[-1].pval,yypvt[-0].pval); } break;
case 73:
/* # line 361 "gram.in" */
{ ((struct atblock *)yypvt[-1].pval)->atdim = yypvt[-0].pval; } break;
case 74:
/* # line 362 "gram.in" */
{ yyval.pval = (int *)ALLOC(atblock); ((struct atblock *)yyval.pval)->atdim = yypvt[-0].pval; } break;
case 75:
/* # line 365 "gram.in" */
{ yyval.pval = 0; } break;
case 77:
...
case 78:
/* # line 370 "gram.in" */
{ inbound = 0;  yyval.pval = arrays = (int *)mkchain(yypvt[-1].pval,arrays); } break;
case 80:
/* # line 374 "gram.in" */
...
/* # line 378 "gram.in" */
{
		yyval.pval = (int *)ALLOC(dimblock);
		((struct dimblock *)yyval.pval)->lowerb = 0;
		((struct dimblock *)yyval.pval)->upperb = yypvt[-0].pval;
		} break;
case 82:
/* # line 384 "gram.in" */
{
		yyval.pval = (int *)ALLOC(dimblock);
		((struct dimblock *)yyval.pval)->lowerb = yypvt[-2].pval;
		((struct dimblock *)yyval.pval)->upperb = yypvt[-0].pval;
		} break;
case 84:
/* # line 392 "gram.in" */
...
{
		if(yypvt[-0].pval!=0)
			if(((struct exprblock /*|| struct varblock */ *)yypvt[-1].pval)->vdim==0)
				((struct exprblock /*|| struct varblock */ *)yypvt[-1].pval)->vdim = yypvt[-0].pval;
			else if(!eqdim(yypvt[-0].pval,((struct exprblock /*|| struct varblock */ *)yypvt[-1].pval)->vdim))
				dclerr("multiple dimension", ((struct stentry *)yypvt[-1].pval)->namep);
		yyval.pval = (int *)mkchain(yypvt[-1].pval,CHNULL);
		} break;
case 90:
/* # line 412 "gram.in" */
{ ininit = YES; } break;
...
/* # line 413 "gram.in" */
{
		...
		if(yypvt[-2].ival!=OPASGN)
			dclerr("illegal initialization operator", ((struct stentry *)((struct defblock /*|| struct labelblock|| struct varblock|| struct keyblock|| struct typeblock */ *)yypvt[-4].pval)->sthead)->namep);
		if(yypvt[-3].pval!=0)
			if(((struct exprblock /*|| struct varblock */ *)yypvt[-4].pval)->vdim==0)
				((struct exprblock /*|| struct varblock */ *)yypvt[-4].pval)->vdim = yypvt[-3].pval;
			else if(!eqdim(yypvt[-3].pval,((struct exprblock /*|| struct varblock */ *)yypvt[-4].pval)->vdim))
				dclerr("multiple dimension", ((struct stentry *)((struct defblock /*|| struct labelblock|| struct varblock|| struct keyblock|| struct typeblock */ *)yypvt[-4].pval)->sthead)->namep);
		if(yypvt[-0].pval!=0 && ((struct varblock *)yypvt[-4].pval)->vinit!=0)
			dclerr("multiple initialization", ((struct stentry *)((struct defblock /*|| struct labelblock|| struct varblock|| struct keyblock|| struct typeblock */ *)yypvt[-4].pval)->sthead)->namep);
		((struct varblock *)yypvt[-4].pval)->vinit = yypvt[-0].pval;
		yyval.pval = (int *)mkchain(yypvt[-4].pval,CHNULL);
		} break;
case 92:
/* # line 430 "gram.in" */
...
/* # line 444 "gram.in" */
{
		yyval.pval = (int *)ALLOC(atblock);
		if(yypvt[-0].ival == CLEXT)
			((struct atblock *)yyval.pval)->atext = 1;
		((struct atblock *)yyval.pval)->atclass = yypvt[-0].ival;
		} break;
case 98:
/* # line 451 "gram.in" */
{
		yyval.pval = (int *)ALLOC(atblock);
		((struct atblock *)yyval.pval)->atclass = CLCOMMON;
		((struct atblock *)yyval.pval)->atcommon = yypvt[-1].pval;
		} break;
case 99:
/* # line 457 "gram.in" */
{ yyval.pval = (int *)ALLOC(atblock); ((struct atblock *)yyval.pval)->attype = yypvt[-0].ival; } break;
case 100:
/* # line 459 "gram.in" */
{ yyval.pval = (int *)ALLOC(atblock); ((struct atblock *)yyval.pval)->attype = TYCHAR; ((struct atblock *)yyval.pval)->attypep = yypvt[-1].pval; } break;
case 101:
/* # line 461 "gram.in" */
{ yyval.pval = (int *)ALLOC(atblock); ((struct atblock *)yyval.pval)->attype = TYFIELD;
		  ((struct atblock *)yyval.pval)->attypep = mkfield(yypvt[-1].pval); } break;
case 102:
/* # line 464 "gram.in" */
{ yyval.pval = (int *)ALLOC(atblock); ((struct atblock *)yyval.pval)->attype = TYSTRUCT;
		  ((struct atblock *)yyval.pval)->attypep = yypvt[-0].pval; } break;
case 103:
/* # line 467 "gram.in" */
{ yyval.pval = (int *)ALLOC(atblock); ((struct atblock *)yyval.pval)->atprec = yypvt[-0].ival; } break;
case 104:
/* # line 470 "gram.in" */
{ yyval.ival = CLAUTO;
...
case 120:
/* # line 503 "gram.in" */
{ yyval.pval = ((struct stentry *)yypvt[-0].pval)->varp; } break;
case 121:
/* # line 505 "gram.in" */
...
case 123:
/* # line 511 "gram.in" */
{ if(((struct stentry *)yypvt[-0].pval)->varp && ((struct headbits *)((struct stentry *)yypvt[-0].pval)->varp)->blklevel<blklevel)
			hide(yypvt[-0].pval);
		  ((struct headbits *)yypvt[-0].pval)->tag = TSTRUCT;
		} break;
case 124:
/* # line 516 "gram.in" */
{ if(((struct stentry *)yypvt[-0].pval)->varp)
			if(((struct headbits *)((struct stentry *)yypvt[-0].pval)->varp)->blklevel<blklevel)
				hide(yypvt[-0].pval);
			else dclerr("multiple declaration for type %s", ((struct stentry *)yypvt[-0].pval)->namep);
		} break;
case 125:
/* # line 523 "gram.in" */
{ ++instruct; } break;
...
case 132:
/* # line 535 "gram.in" */
{ if(((struct headbits *)yypvt[-0].pval)->tag == TCALL)
			yypvt[-0].pval = funcinv(yypvt[-0].pval);
		  if(((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->vtype==TYUNDEFINED && ((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->vext==0)
			impldecl(yypvt[-0].pval);
		  else if(((struct headbits *)yypvt[-0].pval)->tag==TNAME && ((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->vdcldone==0
			  && ((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->vext==0 && !inbound)
				dclit(yypvt[-0].pval);
		  if(((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->vtype==TYFIELD)
...
case 138:
/* # line 553 "gram.in" */
{ if( !ininit && ((struct headbits *)yypvt[-0].pval)->tag== TLIST)
			yyval.pval = compconst(yypvt[-0].pval); 
		  else ((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->needpar = 1; } break;
case 139:
/* # line 557 "gram.in" */
...
case 148:
/* # line 577 "gram.in" */
{ if(((struct headbits *)yypvt[-2].pval)->tag == TCALL)
			{
...
case 152:
/* # line 593 "gram.in" */
{ if(((struct headbits *)yypvt[-0].pval)->tag==TNAME && ((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->vdcldone==0 &&
			((struct exprblock /*|| struct varblock */ *)yypvt[-0].pval)->vsubs==0 && ((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-0].pval)->vext==0 && !inbound)
				dclit(yypvt[-0].pval);
		} break;
case 154:
/* # line 601 "gram.in" */
{
		if(((struct headbits *)yypvt[-0].pval)->tag!=TLIST)
			yypvt[-0].pval = mknode(TLIST,0, mkchain(yypvt[-0].pval,CHNULL), PNULL);
		if(((struct exprblock /*|| struct varblock */ *)yypvt[-1].pval)->vdim)
			{
			if(((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-1].pval)->vdcldone==0 && ((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-1].pval)->vext==0)
				dclit(yypvt[-1].pval);
			yyval.pval = (int *)subscript(yypvt[-1].pval,yypvt[-0].pval);
			}
...
{ if(((struct headbits *)yypvt[-0].pval)->tag != TLIST)
			yypvt[-0].pval = mknode(TLIST,0, mkchain(yypvt[-0].pval,CHNULL), PNULL);
		  yyval.pval = (int *)subscript(strucelt(yypvt[-3].pval,yypvt[-1].pval), yypvt[-0].pval);
		} break;
case 157:
/* # line 620 "gram.in" */
...
case 158:
/* # line 624 "gram.in" */
{ if(((struct stentry *)yypvt[-0].pval)->varp == 0) mkvar(yypvt[-0].pval);
		  if(inbound)
			  ((struct varblock *)((struct stentry *)yypvt[-0].pval)->varp)->vadjdim = 1;
		  if(((struct headbits *)yypvt[-0].pval)->tag == TLABEL)
			{
			laberr("attempt to use label as name",((struct stentry *)((struct stentry *)yypvt[-0].pval)->varp)->namep);
			yyval.pval = errnode();
			}
		  else
		  	yyval.pval = cpexpr(((struct stentry *)yypvt[-0].pval)->varp);
		} break;
case 159:
/* # line 638 "gram.in" */
...
case 164:
/* # line 652 "gram.in" */
{ yyval.pval = esizeof(((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-1].pval)->vtype, ((struct exprblock /*|| struct varblock */ *)yypvt[-1].pval)->vtypep, ((struct exprblock /*|| struct varblock */ *)yypvt[-1].pval)->vdim);
		  frexpr(yypvt[-1].pval); } break;
case 165:
/* # line 655 "gram.in" */
{ if(((struct atblock *)yypvt[-1].pval)->attype==TYREAL && ((struct atblock *)yypvt[-1].pval)->atprec)
			((struct atblock *)yypvt[-1].pval)->attype = TYLREAL;
		  yyval.pval = esizeof(((struct atblock *)yypvt[-1].pval)->attype, ((struct atblock *)yypvt[-1].pval)->attypep, ((struct atblock *)yypvt[-1].pval)->atdim);
		  cfree(yypvt[-1].pval);
		} break;
case 166:
/* # line 661 "gram.in" */
...
case 167:
/* # line 665 "gram.in" */
{ yyval.pval = elenof(((struct iostblock /*|| struct exprblock|| struct varblock */ *)yypvt[-1].pval)->vtype, ((struct exprblock /*|| struct varblock */ *)yypvt[-1].pval)->vtypep, ((struct exprblock /*|| struct varblock */ *)yypvt[-1].pval)->vdim);
		  frexpr(yypvt[-1].pval); } break;
case 168:
/* # line 668 "gram.in" */
{ yyval.pval = elenof(((struct atblock *)yypvt[-1].pval)->attype, ((struct atblock *)yypvt[-1].pval)->attypep, ((struct atblock *)yypvt[-1].pval)->atdim);
		  cfree(yypvt[-1].pval);
		} break;
case 169:
/* # line 672 "gram.in" */
...
/* # line 692 "gram.in" */
{
		if(((struct headbits *)yypvt[-2].pval)->tag==TCALL)
			...
			dclerr("no statement functions in EFL",
				((struct stentry *)((struct defblock /*|| struct labelblock|| struct varblock|| struct keyblock|| struct typeblock */ *)yypvt[-2].pval)->sthead)->namep);
			frexpr(yypvt[-2].pval);
			frexpr(yypvt[-0].pval);
			}
...
case 182:
/* # line 713 "gram.in" */
{ ((struct execblock *)thisexec)->labeled = 1; } break;
case 183:
/* # line 715 "gram.in" */
{ ((struct execblock *)thisexec)->uniffable = 1;  popctl(); } break;
case 184:
/* # line 717 "gram.in" */
{ ((struct execblock *)thisexec)->brnchend = 1; } break;
case 185:
/* # line 719 "gram.in" */
...
{ TEST fprintf(diagfile, "if-then-else\n");
		  i = ((struct labelblock /*|| struct caseblock|| struct execblock */ *)yypvt[-5].pval)->brnchend & ((struct labelblock /*|| struct caseblock|| struct execblock */ *)yypvt[-0].pval)->brnchend;
		  addexec();
		  yyval.pval = addexec();
		  ((struct execblock *)thisexec)->brnchend = i;
...
/* # line 796 "gram.in" */
{
		...
		exlab( indifs[((struct ctlblock *)thisctl)->indifn] = nextlab() );
		} break;
case 206:
/* # line 806 "gram.in" */
...
{ pushlex = 1;
		  yyclearin;
		  yyval.pval = addexec();
		  exgoto(((struct ctlblock *)thisctl)->xlab);
...
{ yyval.pval = addexec();
		  exnull();
		  exlab( indifs[((struct ctlblock *)thisctl)->indifn] = nextlab() );
		  exifgo(mknode(TNOTOP,OPNOT,yypvt[-1].pval,PNULL), ((struct ctlblock *)thisctl)->xlab);
...
case 213:
/* # line 832 "gram.in" */
{ if( !equals(((struct stentry *)yypvt[-1].pval)->namep, "to") )
			execerr("go %s ??\n", ((struct stentry *)yypvt[-1].pval)->namep);
...
case 215:
/* # line 839 "gram.in" */
{ if(!equals(((struct stentry *)yypvt[-2].pval)->namep, "to") )
			execerr("go %s ??\n", ((struct stentry *)yypvt[-2].pval)->namep);
...
case 217:
/* # line 851 "gram.in" */
{ yyval.pval = (int *)mkchain(yypvt[-0].ival,CHNULL); } break;
case 218:
/* # line 853 "gram.in" */
{ yyval.pval = (int *)hookup(yypvt[-2].pval, mkchain(yypvt[-0].ival,CHNULL) ); } break;
case 220:
/* # line 858 "gram.in" */
...
case 280:
/* # line 1004 "gram.in" */
{ yyval.pval = ((struct iostblock /*|| struct exprblock */ *)yypvt[-1].pval)->leftp; frexpblock(yypvt[-1].pval); } break;
case 281:
/* # line 1007 "gram.in" */
{ yyval.ival = yypvt[-1].ival; } break;
case 282:
