...
EDITS = [
    dict(
        path='history/ix/src/jerq/mux/mux.c',
        sha='c445a58c5f77050e9d621d29e902f3c3a9de91734e3f04d46bde7c0e07db1cea',
        title="mux.c: IX's labels and process exclusion, excised (K15)",
    ...
    dict(
        path='history/ix/src/jerq/mux/32ld.c',
        sha='afd84395e5194a020a744dd02e4dd51b5fa0eea3a8f5aabd577663ec50c40a82',
        title='32ld.c: the IX download label check, excised (K15)',
