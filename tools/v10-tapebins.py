...
# ONE EXCLUSION, AND IT IS NOT A JUDGEMENT ABOUT QUALITY: src/history/ix is a
# DIFFERENT OPERATING SYSTEM.  Its own README says so --
#
#   "This is the /usr file system for ix, shorn of most material that may be
#    copied bodily from research unix (v8,v9,v10).  ...  As ix uses a
#    different size inode, it will take considerable work to bring the stuff
#    up; you must begin with mkfs."
#
# So it is not a subset of V10 and its binaries are not V10 binaries.  Seven
# of them were being installed onto a Tenth Edition disk, including `ps' over
# V10's own and `su' into /etc.
#
