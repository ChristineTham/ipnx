static	char *sccsid = "@(#)y.tab.c	1.1 (Berkeley) 3/2/81";
...
case 2: yyval = (int *)funcbody(funchdr(tree5(T_PROG, lineof(yyYpv[1]), yyYpv[2], fixlist(yyYpv[4]), NIL))); break;
case 3: {
...
case 13: yyval = (int *)newlist(yyYpv[1] == NIL ? NIL : *hash(yyYpv[1], 1)); break;
case 14: yyval = (int *)addlist(yyYpv[1], yyYpv[3] == NIL ? NIL : *hash(yyYpv[3], 1)); break;
...
case 32: yyval = (int *)funchdr(tree5(yyYpv[1], lineof(yyYpv[5]), yyYpv[2], yyYpv[3], yyYpv[4])); break;
case 33: yyval = (int *)T_PDEC; break;
case 34: yyval = (int *)T_FDEC; break;
case 35: yyval = (int *)fixlist(yyYpv[2]); break;
case 36: yyval = NIL; break;
case 37: yyval = (int *)tree3(T_PVAL, fixlist(yyYpv[1]), yyYpv[3]); break;
case 38: yyval = (int *)tree3(T_PVAR, fixlist(yyYpv[2]), yyYpv[4]); break;
case 39: yyval = (int *)tree3(T_PFUNC, fixlist(yyYpv[2]), yyYpv[4]); break;
case 40: yyval = (int *)tree2(T_PPROC, fixlist(yyYpv[2])); break;
case 41: yyval = yyYpv[2]; break;
case 42: yyval = NIL; break;
case 43: yyval = (int *)newlist(yyYpv[1]); break;
case 44: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
case 45: yyval = (int *)tree2(T_CSTRNG, yyYpv[1]); break;
case 47: yyval = (int *)tree2(T_PLUSC, yyYpv[2]); break;
case 48: yyval = (int *)tree2(T_MINUSC, yyYpv[2]); break;
case 49: yyval = (int *)tree2(T_ID, yyYpv[1]); break;
case 50: yyval = (int *)tree2(T_CINT, yyYpv[1]); break;
case 51: yyval = (int *)tree2(T_CBINT, yyYpv[1]); break;
case 52: yyval = (int *)tree2(T_CFINT, yyYpv[1]); break;
case 53: yyval = (int *)newlist(yyYpv[1]); break;
case 54: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
case 56: yyval = (int *)tree3(T_TYPTR, lineof(yyYpv[1]), tree2(T_ID, yyYpv[2])); break;
case 58: yyval = (int *)tree3(T_TYPACK, lineof(yyYpv[1]), yyYpv[2]); break;
case 60: yyval = (int *)tree3(T_TYSCAL, lineof(yyYpv[1]), fixlist(yyYpv[2])); break;
case 61: yyval = (int *)tree4(T_TYRANG, lineof(yyYpv[2]), yyYpv[1], yyYpv[3]); break;
case 62: yyval = (int *)tree4(T_TYARY, lineof(yyYpv[1]), fixlist(yyYpv[3]), yyYpv[6]); break;
case 63: yyval = (int *)tree3(T_TYFILE, lineof(yyYpv[1]), yyYpv[3]); break;
case 64: yyval = (int *)tree3(T_TYSET, lineof(yyYpv[1]), yyYpv[3]); break;
case 65: {
			yyval = (int *)tree3(T_TYREC, lineof(yyYpv[1]), yyYpv[2]);
			if (yyYpv[3] < 0)
				brerror(yyYpv[1], "record");
		  } break;
case 66: yyval = (int *)newlist(yyYpv[1]); break;
case 67: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
case 68: yyval = (int *)tree4(T_FLDLST, lineof(NIL), fixlist(yyYpv[1]), yyYpv[2]); break;
case 69: yyval = (int *)newlist(yyYpv[1]); break;
case 70: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
case 71: yyPerror("Malformed record declaration", PDECL); break;
case 72: yyval = NIL; break;
case 73: yyval = (int *)tree4(T_RFIELD, lineof(yyYpv[2]), fixlist(yyYpv[1]), yyYpv[3]); break;
case 74: yyval = NIL; break;
case 75: yyval = (int *)tree5(T_TYVARPT, lineof(yyYpv[1]), NIL, yyYpv[2], fixlist(yyYpv[4])); break;
case 76: yyval = (int *)tree5(T_TYVARPT, lineof(yyYpv[1]), yyYpv[2], yyYpv[4], fixlist(yyYpv[6])); break;
case 77: yyval = (int *)newlist(yyYpv[1]); break;
case 78: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
case 79: yyPerror("Malformed record declaration", PDECL); break;
case 80: yyval = NIL; break;
case 81: yyval = (int *)tree4(T_TYVARNT, lineof(yyYpv[2]), fixlist(yyYpv[1]), yyYpv[4]); break;
case 82: yyval = (int *)tree4(T_TYVARNT, lineof(yyYpv[2]), fixlist(yyYpv[1]), NIL); break;
case 83: yyval = (int *)newlist(yyYpv[1]); break;
case 84: {
...
case 85: if ((q = yyYpv[1]) != NIL && (p = (int *)q[1]) != NIL && p[0] == T_IF) {
			if (yychar < 0)
				yychar = yylex();
...
case 86: yyval = (int *)newlist(yyYpv[1]); break;
case 87: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
case 88: {
			yyval = NIL;
Kerror:
...
case 90: yyval = (int *)tree4(T_CSTAT, lineof(yyYpv[2]), fixlist(yyYpv[1]), yyYpv[3]); break;
case 91: yyval = (int *)tree4(T_CSTAT, lineof(yyYpv[1]), NIL, yyYpv[2]); break;
case 92: yyval = NIL; break;
case 93: yyval = NIL; break;
case 94: yyval = (int *)tree4(T_LABEL, lineof(yyYpv[2]), yyYpv[1] == NIL ? NIL : *hash(yyYpv[1], 1), yyYpv[3]); break;
case 95: yyval = (int *)tree4(T_PCALL, lineof(yyline), yyYpv[1], NIL); break;
case 96: yyval = (int *)tree4(T_PCALL, lineof(yyYpv[2]), yyYpv[1], fixlist(yyYpv[3])); break;
...
case 101: yyval = (int *)tree4(T_WITH, lineof(yyYpv[1]), fixlist(yyYpv[2]), yyYpv[4]); break;
case 102: yyval = (int *)tree4(T_WHILE, lineof(yyYpv[1]), yyYpv[2], yyYpv[4]); break;
case 103: yyval = (int *)tree4(T_REPEAT, lineof(yyYpv[3]), fixlist(yyYpv[2]), yyYpv[4]); break;
case 104: yyval = (int *)tree5(T_FORU, lineof(yyYpv[1]), yyYpv[2], yyYpv[4], yyYpv[6]); break;
case 105: yyval = (int *)tree5(T_FORD, lineof(yyYpv[1]), yyYpv[2], yyYpv[4], yyYpv[6]); break;
case 106: yyval = (int *)tree3(T_GOTO, lineof(yyYpv[1]), *hash(yyYpv[2], 1)); break;
case 107: yyval = (int *)tree5(T_IF, lineof(yyYpv[1]), yyYpv[2], yyYpv[4], NIL); break;
case 108: yyval = (int *)tree5(T_IFEL, lineof(yyYpv[1]), yyYpv[2], yyYpv[4], yyYpv[6]); break;
case 109: yyval = (int *)tree5(T_IFEL, lineof(yyYpv[1]), yyYpv[2], yyYpv[4], NIL); break;
case 110: yyval = (int *)tree3(T_ASRT, lineof(yyYpv[1]), yyYpv[3]); break;
case 111: {
NSerror:
			yyval = NIL;
Serror:
...
case 112: yyval = (int *)tree4(T_ASGN, lineof(yyYpv[2]), yyYpv[1], yyYpv[4]); break;
case 113: {
NEerror:
			yyval = NIL;
Eerror:
...
case 114: yyval = (int *)tree4(yyYpv[2], yyYpv[1][1] == SAWCON ? yyYpv[3][1] : yyYpv[1][1], yyYpv[1], yyYpv[3]); break;
case 115: yyval = (int *)tree3(T_PLUS, yyYpv[2][1], yyYpv[2]); break;
case 116: yyval = (int *)tree3(T_MINUS, yyYpv[2][1], yyYpv[2]); break;
case 117: yyval = (int *)tree4(yyYpv[2], yyYpv[1][1] == SAWCON ? yyYpv[3][1] : yyYpv[1][1], yyYpv[1], yyYpv[3]); break;
case 118: yyval = (int *)tree4(yyYpv[2], yyYpv[1][1] == SAWCON ? yyYpv[3][1] : yyYpv[1][1], yyYpv[1], yyYpv[3]); break;
case 119: yyval = (int *)tree2(T_NIL, NOCON); break;
case 120: yyval = (int *)tree3(T_STRNG, SAWCON, yyYpv[1]); break;
case 121: yyval = (int *)tree3(T_INT, NOCON, yyYpv[1]); break;
case 122: yyval = (int *)tree3(T_BINT, NOCON, yyYpv[1]); break;
case 123: yyval = (int *)tree3(T_FINT, NOCON, yyYpv[1]); break;
case 125: goto NEerror; break;
case 126: yyval = (int *)tree4(T_FCALL, NOCON, yyYpv[1], fixlist(yyYpv[3])); break;
case 127: yyval = yyYpv[2]; break;
case 128: yyval = (int *)tree3(T_NOT, NOCON, yyYpv[2]); break;
case 129: yyval = (int *)tree3(T_CSET, SAWCON, fixlist(yyYpv[2])); break;
case 130: yyval = (int *)tree3(T_CSET, SAWCON, NIL); break;
case 131: yyval = (int *)newlist(yyYpv[1]); break;
case 132: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
case 134: yyval = (int *)tree3(T_RANG, yyYpv[1], yyYpv[3]); break;
case 135: {
			yyval = (int *)setupvar(yyYpv[1], NIL);
		  } break;
case 136: yyYpv[1][3] = fixlist(yyYpv[1][3]); break;
case 137: yyval = (int *)setupvar(yyYpv[1], tree2(T_ARY, fixlist(yyYpv[3]))); break;
case 138: yyYpv[1][3] = addlist(yyYpv[1][3], tree2(T_ARY, fixlist(yyYpv[3]))); break;
case 139: yyval = (int *)setupvar(yyYpv[1], tree3(T_FIELD, yyYpv[3], NIL)); break;
case 140: yyYpv[1][3] = addlist(yyYpv[1][3], tree3(T_FIELD, yyYpv[3], NIL)); break;
case 141: yyval = (int *)setupvar(yyYpv[1], tree1(T_PTR)); break;
case 142: yyYpv[1][3] = addlist(yyYpv[1][3], tree1(T_PTR)); break;
case 144: yyval = (int *)tree4(T_WEXP, yyYpv[1], yyYpv[3], NIL); break;
case 145: yyval = (int *)tree4(T_WEXP, yyYpv[1], yyYpv[3], yyYpv[5]); break;
case 146: yyval = (int *)tree4(T_WEXP, yyYpv[1], NIL, yyYpv[2]); break;
case 147: yyval = (int *)tree4(T_WEXP, yyYpv[1], yyYpv[3], yyYpv[4]); break;
case 148: yyval = (int *)OCT; break;
case 149: yyval = (int *)HEX; break;
case 150: yyval = (int *)newlist(yyYpv[1]); break;
case 151: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
case 152: yyval = (int *)newlist(yyYpv[1]); break;
case 153: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
case 154: yyval = (int *)T_EQ; break;
case 155: yyval = (int *)T_LT; break;
case 156: yyval = (int *)T_GT; break;
case 157: yyval = (int *)T_NE; break;
case 158: yyval = (int *)T_LE; break;
case 159: yyval = (int *)T_GE; break;
case 160: yyval = (int *)T_IN; break;
case 161: yyval = (int *)T_ADD; break;
case 162: yyval = (int *)T_SUB; break;
case 163: yyval = (int *)T_OR; break;
case 164: yyval = (int *)T_OR; break;
case 165: yyval = (int *)T_MULT; break;
case 166: yyval = (int *)T_DIVD; break;
case 167: yyval = (int *)T_DIV; break;
case 168: yyval = (int *)T_MOD; break;
case 169: yyval = (int *)T_AND; break;
case 170: yyval = (int *)T_AND; break;
case 173: yyval = (int *)newlist(yyYpv[1]); break;
case 174: yyval = (int *)addlist(yyYpv[1], yyYpv[3]); break;
