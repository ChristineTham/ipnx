...
static char sccsid[] = "@(#)stkrval.c 1.4 3/8/81";
...
#				endif PC
			...
			if (q == nl+T1CHAR) {
#			    ifdef OBJ
				put(2, O_CONC4, (int)p->u.vals.value[0]);
#			    endif OBJ
#			    ifdef PC
				putleaf( P2ICON , p ->u.vals.value[0] , 0 , P2CHAR , 0 );
#			    endif PC
			    return(q);
			}
			/*
...
#			ifdef OBJ
			    ...
			    case 4:
				    ...
				    return(q);
			    case 2:
				    put(2, O_CON24, (short)p->u.rngs.range[0]);
				    return(q);
			    case 1:
				    put(2, O_CON14, p->u.vals.value[0]);
				    return(q);
			    default:
				    panic("stkrval");
			    }
