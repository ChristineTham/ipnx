...
case 10:
/* # line 170 "../common/cgram.y" */
{	regvar = 0; } break;
case 11:
/* # line 174 "../common/cgram.y" */
{ curclass = SNULL;  yypvt[-2].nodep->in.op = FREE; } break;
case 12:
/* # line 177 "../common/cgram.y" */
{ curclass = SNULL;  yypvt[-1].nodep->in.op = FREE; } break;
case 13:
/* # line 178 "../common/cgram.y" */
{  blevel = 1; } break;
case 15:
/* # line 183 "../common/cgram.y" */
{  bccode();
			    locctr(PROG);
			    } break;
case 16:
/* # line 189 "../common/cgram.y" */
{  yypvt[-1].nodep->in.op = FREE; } break;
case 17:
/* # line 191 "../common/cgram.y" */
{  yypvt[-2].nodep->in.op = FREE; } break;
case 20:
/* # line 197 "../common/cgram.y" */
...
case 60:
/* # line 335 "../common/cgram.y" */
{ yyval.nodep=yypvt[-1].nodep; } break;
case 61:
/* # line 338 "../common/cgram.y" */
{  goto umul; } break;
case 62:
/* # line 340 "../common/cgram.y" */
{  goto uftn; } break;
case 63:
/* # line 342 "../common/cgram.y" */
{  goto uary; } break;
case 64:
/* # line 344 "../common/cgram.y" */
{  goto bary; } break;
case 65:
/* # line 346 "../common/cgram.y" */
{ yyval.nodep = yypvt[-1].nodep; } break;
case 66:
/* # line 348 "../common/cgram.y" */
{ if (paramno)
				uerror("arg list in declaration"); } break;
case 67:
/* # line 351 "../common/cgram.y" */
{
				if( blevel!=0 )
					uerror(
...
{  doinit( yypvt[-0].nodep );
			    endinit(); } break;
case 82:
/* # line 406 "../common/cgram.y" */
{  endinit(); } break;
case 86:
/* # line 416 "../common/cgram.y" */
{  doinit( yypvt[-0].nodep ); } break;
case 87:
/* # line 418 "../common/cgram.y" */
{  irbrace(); } break;
case 92:
/* # line 430 "../common/cgram.y" */
{  ilbrace(); } break;
case 93:
/* # line 436 "../common/cgram.y" */
{
			    clearst(blevel);
			    if (--blevel == 1)
			    {
...
case 95:
/* # line 460 "../common/cgram.y" */
{ ecomp(yypvt[-1].nodep); } break;
case 96:
/* # line 462 "../common/cgram.y" */
{ asmout(); } break;
case 98:
/* # line 465 "../common/cgram.y" */
...
/* # line 487 "../common/cgram.y" */
{
				...
				case LL_TOP:	/* test at loop top */
					deflab(contlab);
					if (yypvt[-1].nodep->in.op == ICON && yypvt[-1].nodep->tn.lval) {
						flostat = FLOOP;
						tfree(yypvt[-1].nodep);
					} else {
...
/* # line 600 "../common/cgram.y" */
{
				...
				case LL_TOP:	/* test at loop top */
					...
					if (!yypvt[-1].nodep)
						flostat |= FLOOP;
					else if (yypvt[-1].nodep->in.op == ICON && yypvt[-1].nodep->tn.lval) {
						flostat |= FLOOP;
						tfree(yypvt[-1].nodep);
...
case 118:
/* # line 779 "../common/cgram.y" */
{  addcase(yypvt[-1].nodep);
			    reached = 1;
			    } break;
case 119:
/* # line 783 "../common/cgram.y" */
{  reached = 1;
			    adddef();
			    flostat |= FDEF;
			    } break;
case 120:
/* # line 789 "../common/cgram.y" */
{  savebc();
...
case 124:
/* # line 837 "../common/cgram.y" */
{ yyval.intval=instruct; stwart=instruct=0; } break;
case 125:
/* # line 839 "../common/cgram.y" */
{  yyval.intval = icons( yypvt[-0].nodep ); instruct=yypvt[-1].intval; } break;
case 127:
/* # line 843 "../common/cgram.y" */
{ yyval.nodep = 0; } break;
case 129:
/* # line 848 "../common/cgram.y" */
{  goto bop; } break;
case 130:
/* # line 852 "../common/cgram.y" */
{
			preconf:
...
case 131:
/* # line 865 "../common/cgram.y" */
{  yypvt[-1].intval = COMOP;
			    goto bop;
			    } break;
case 132:
/* # line 869 "../common/cgram.y" */
{  goto bop; } break;
case 133:
/* # line 871 "../common/cgram.y" */
{  if(yychar==SHIFTOP) goto precplaint; else goto bop; } break;
case 134:
/* # line 873 "../common/cgram.y" */
{  if(yychar==SHIFTOP ) goto precplaint; else goto bop; } break;
case 135:
/* # line 875 "../common/cgram.y" */
{  if(yychar==PLUS||yychar==MINUS) goto precplaint; else goto bop; } break;
case 136:
/* # line 877 "../common/cgram.y" */
{  goto bop; } break;
case 137:
/* # line 879 "../common/cgram.y" */
{  goto preconf; } break;
case 138:
/* # line 881 "../common/cgram.y" */
{  if( yychar==RELOP||yychar==EQUOP ) goto preconf;  else goto bop; } break;
case 139:
/* # line 883 "../common/cgram.y" */
{  if(yychar==RELOP||yychar==EQUOP) goto preconf; else goto bop; } break;
case 140:
/* # line 885 "../common/cgram.y" */
{  if(yychar==RELOP||yychar==EQUOP) goto preconf; else goto bop; } break;
case 141:
/* # line 887 "../common/cgram.y" */
{  goto bop; } break;
case 142:
/* # line 889 "../common/cgram.y" */
{  goto bop; } break;
case 143:
/* # line 891 "../common/cgram.y" */
{  abop:
				yyval.nodep = buildtree( ASG yypvt[-2].intval, yypvt[-3].nodep, yypvt[-0].nodep );
				} break;
case 144:
/* # line 895 "../common/cgram.y" */
{  goto abop; } break;
case 145:
/* # line 897 "../common/cgram.y" */
{  goto abop; } break;
case 146:
/* # line 899 "../common/cgram.y" */
{  goto abop; } break;
case 147:
/* # line 901 "../common/cgram.y" */
{  goto abop; } break;
case 148:
/* # line 903 "../common/cgram.y" */
{  goto abop; } break;
case 149:
/* # line 905 "../common/cgram.y" */
{  goto abop; } break;
case 150:
/* # line 907 "../common/cgram.y" */
{  goto abop; } break;
case 151:
/* # line 909 "../common/cgram.y" */
{  yyval.nodep=buildtree(QUEST, yypvt[-4].nodep, buildtree( COLON, yypvt[-2].nodep, yypvt[-0].nodep ) );
			    } break;
case 152:
/* # line 912 "../common/cgram.y" */
{  werror( "old-fashioned assignment operator" );
				goto bop; } break;
case 153:
/* # line 915 "../common/cgram.y" */
{  goto bop; } break;
case 155:
/* # line 920 "../common/cgram.y" */
{  yyval.nodep = buildtree( yypvt[-0].intval, yypvt[-1].nodep, bcon(1) ); } break;
case 156:
/* # line 922 "../common/cgram.y" */
{ ubop:
			   yyval.nodep = buildtree( UNARY yypvt[-1].intval, yypvt[-0].nodep, NIL );
			    } break;
case 157:
/* # line 926 "../common/cgram.y" */
{
#ifdef M32B
			    myand(yypvt[-0].nodep);
#endif
...
case 171:
/* # line 998 "../common/cgram.y" */
{   yyval.nodep=buildtree(FCON,NIL,NIL);
			    yyval.nodep->fpn.dval = dcon;
			    } break;
case 172:
/* # line 1002 "../common/cgram.y" */
{  yyval.nodep = getstr(); } break;
case 173:
/* # line 1004 "../common/cgram.y" */
{  yyval.nodep=yypvt[-1].nodep; } break;
case 174:
/* # line 1008 "../common/cgram.y" */
{
...
case 175:
/* # line 1016 "../common/cgram.y" */
{ yyval.nodep = bdty( NAME, NIL, -1 ); } break;
case 176:
/* # line 1018 "../common/cgram.y" */
{ yyval.nodep = bdty( UNARY CALL, bdty(NAME,NIL,-1),0); } break;
case 177:
/* # line 1020 "../common/cgram.y" */
{  yyval.nodep = bdty( UNARY CALL, yypvt[-3].nodep, 0 ); } break;
case 178:
/* # line 1022 "../common/cgram.y" */
{  goto umul; } break;
case 179:
/* # line 1024 "../common/cgram.y" */
{  goto uary; } break;
case 180:
/* # line 1026 "../common/cgram.y" */
{  goto bary;  } break;
case 181:
/* # line 1028 "../common/cgram.y" */
{ yyval.nodep = yypvt[-1].nodep; } break;
case 182:
/* # line 1032 "../common/cgram.y" */
