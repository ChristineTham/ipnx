typedef unsigned size_t;	/* ipnx size_t */
	...
	char **argv;
{
	...
	KMlseek(kmem, (long)nl[X_DMMAX].n_value, 0);
	...
	struct asav *ap;
{
	...
	printf("%4ld:%02ld", ap->a_cpu / hz, ap->a_cpu % hz);
}
